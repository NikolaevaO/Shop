...
let app = new Vue ({
	...
	methods: {
		...
		submitOrder () {
			// Поскольку github pages не дает возможности использовать back-end, используется заглушка
			alert ('Благодарим за интерес к нашему сервису, но раздел пока в разработке :)');
		},
